...
<div class="UI-C_R">
    <div class="UI-Block UI-B_FIRST">
        <div class="UI-Title">Обновление 1.1</div>
        <div class="UI-B_CONTENT">
            <div>Для Premium пользователей:</div>
            ...
            <div>• Теперь список Premium пользователей есть на главной странице.</div>
    ...
    <?php if (CheckGoldUser($Account['ID']) == false): ?>
        <div class="UI-AD_N2-B">
            ...
            <div class="UI-AD-T">реклама шредингера она есть и ее нет</div>
            <div class="UI-AD_C_BOTTOM">
                <a class="UI-AD_BTN" href=""></a>
            </div>
    ...
    <div class="UI-Block">
        <div class="UI-Title" style="width: 100%;">Premium пользователи</div>
